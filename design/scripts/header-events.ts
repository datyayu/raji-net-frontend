...
Array.prototype.forEach.call($sidebarTogglers, node => {
    node.addEventListener('click', toggleSidenav)
})

Array.prototype.forEach.call($searchTogglers, node => {
    node.addEventListener('click', toggleSearch)
})

Array.prototype.forEach.call($playlistTogglers, node => {
...
$overlay.addEventListener('click', event => {
    ...
    Array.prototype.forEach.call($activeElements, node => {
